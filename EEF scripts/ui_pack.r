...
eefHelp <- function() {
  tagList(
    ...
    div(id="eef-help-close",a(href="javascript:void(0)",img(src="icons/times.svg",height=24,width=24))) #related styles in EEFextra.css for id: #eef-help-close  (close pop up)
  )
}
...
eefHeader <- function(id="equality") {
  ...
  div(class="w3-display-container eef-header-box eef-clearfix",#related styles in EEFextra.css for class: .eef-header-box (invisible box containing the header)
      ...
      div(class="eef-header",
          ...
          div(id="eef-header-main-logo",class="eef-header-left msie11 eef eef-main",img(src="icons/comando_logo.png")),
          div(id="eef-header-sg-logo",class="eef-header-right eef eef-main",img(src="icons/gore_logo.png")),
          shinyjs::hidden(div(class=paste("hidden-xs eef-header-right msie11 eef",policyCSS,paste0("eef-summ-",equalityCharacteristicsID,collapse=" ")),img(src="icons/comando_logo.png")))
      ),
      div(class="eef-header-menu",
          a(id=ns("menu1"),href="javascript:void(0)",`data-value`="equality",img(src="icons/comando_logo.png",height="42px",width="117px"),class=paste("eef-page-links2 eef-page-links20")),
          a(id=ns("menu2"),href="javascript:void(0)","Inicio",class="eef-page-links2 eef-page-links25"),#class "eef eef-XXXX" shows/hides components when on/not on page XXXX 
          a(id=ns("menu3"),href="https://diresacusco2020.maps.arcgis.com/apps/opsdashboard/index.html#/a28819de66a14c059498b7e02f08a781","Espacios de concertacion",class="eef-page-links2 eef-page-links25"),
          a(id=ns("menu4"),href="https://geresacusco.shinyapps.io/DASHBOARD_COVID-19_CUSCO/","Dejanos tu opinion",class="eef-page-links2 eef-page-links15"),
          a(id=ns("menu5"),href="javascript:void(0)","Informacion Estadistica",class="eef-page-links2 eef-page-links15")
      )
  )
}
               ...
               lapply(equalityCharacteristicsID,function(e) {#equalityCharacteristicsID are all the characteristic ID values, and is a variable created in helper_funcs.r
                 tagList(
                   tags$button(equalityLabel(e),class="eef-mobile-grid main",style="color:white",#equalityLabel is a function created in helper_funcs.r that converts characteristic IDs into the corresponding label
                               ...
                               tags$img(src="icons/plus-square.svg",class="",title="Click para mostrar seccion"),
                               shinyjs::shown(tags$img(src="icons/minus-square.svg",class="",title="Click para ocultar seccion"))
                   ),
                   shinyjs::shown(
                     div(
...
eefSection <- function(id,title,class="",colour="eef-mid-blue",tabs=NULL,content=NULL) {
  ...
  div(
    id=ns("section"),
    class=paste("w3-row  w3-content",class),style="width:100%;",
    br(),
    br(),
    tags$button(
      id = ns("header"),
...
eefFooter = function(id)  tags$footer(class="w3-center eef-footer eef-blue w3-padding-64",
                                      tags$a(class="eef-footer-top",href="javascript:void(0);",class="w3-button e3-opacity-blue w3-hover-white", tags$i(class="fa fa-arrow-up w3-margin-right"),"Al inicio")
